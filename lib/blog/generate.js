...
Respond with ONLY valid JSON. No markdown fences. No commentary.`
  ...
  for (let attempt = 0; attempt < 2; attempt++) {
    try {
      // Keep each attempt under the Vercel Hobby 60s function limit
      const raw = await callAi({ provider: textProvider, prompt, json: true, maxTokens: 3000, timeoutMs: 48000 })
