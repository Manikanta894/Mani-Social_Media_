...
export const TABLES = {
  ...
  topicQueue:     { sheet: 'Topic Queue',       columns: ['id', 'topic', 'status', 'created_at', 'updated_at'] },
  ...
  mediaLibrary:   { sheet: 'Image Library',     columns: ['id', 'file_id', 'name', 'mime', 'url', 'size', 'source', 'prompt', 'created_at'] },
  appState:       { sheet: 'User Settings',     columns: ['id', 'key', 'value', 'updated_at'] },
  driveQueue:     { sheet: 'Publishing Queue',  columns: ['id', 'file_id', 'file_name', 'status', 'folder_prefix', 'source', 'discovered_at', 'updated_at', 'queue_position', 'content_job_id', 'scheduled_time', 'platform_content', 'published_platforms', 'failed_platforms', 'published_date', 'archive_date', 'approved_at', 'error', 'retry_count', 'max_retries', 'content', 'image_url'] },
  linkedinIntel:  { sheet: 'LinkedIn Intel',     columns: ['id', 'title', 'url', 'summary', 'author', 'topic', 'post_age_minutes', 'relevance', 'engagement', 'opportunity', 'why', 'comment', 'quality', 'visibility', 'status', 'commented_at', 'created_at', 'updated_at'] },
...
const CACHE_TTL = 20000          // 20s — single user, plenty to dodge quota
