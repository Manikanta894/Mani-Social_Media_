...
import { callAi, callVisionWithFallback, pickTextProvider } from './providers'
...
- instagram: storytelling, emotional, 40-120 words, 8-15 hashtags
...
- Generate 8-15 HIGH-QUALITY hashtags in the "hashtags" array.
- Mix: broad + medium-competition + niche + trending + industry-specific.
- ALWAYS output proper hashtags WITH the # prefix (e.g. "#BusinessAnalytics", "#FutureOfWork", "#LinkedInTips").
- NEVER output plain words without #. NEVER single words like "marketing" or "linkedin".
