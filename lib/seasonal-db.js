...
export const EVENTS = [
  ...
  { m: 1, d: 9, n: 'CES — Consumer Electronics Show', t: 'tech', c: 'USA', r: 'Las Vegas', i: 'tech', e: '📺', p: 90, tr: 93, df: 2, ct: ['Thought Leadership', 'Announcement', 'Educational'], d: 'The world\u2019s biggest tech showcase.' },
  { m: 3, d: 3, n: 'MWC — Mobile World Congress', t: 'tech', c: 'Spain', r: 'Barcelona', i: 'tech', e: '📱', p: 85, tr: 88, df: 2, ct: ['Thought Leadership', 'Announcement'], d: 'Global mobile & connectivity expo.' },
  { m: 5, d: 14, n: 'Google I/O', t: 'tech', c: 'USA', r: 'Global', i: 'tech', e: '🔷', p: 88, tr: 92, df: 2, ct: ['Announcement', 'Thought Leadership'], d: 'Google\u2019s annual developer conference.' },
  { m: 6, d: 10, n: 'Apple WWDC', t: 'tech', c: 'USA', r: 'Global', i: 'tech', e: '🍎', p: 89, tr: 93, df: 2, ct: ['Announcement', 'Thought Leadership'], d: 'Apple\u2019s Worldwide Developers Conference.' },
  { m: 7, d: 21, n: 'OpenAI DevDay', t: 'tech', c: 'Global', r: 'Global', i: 'tech', e: '🤖', p: 82, tr: 95, df: 2, ct: ['Announcement', 'Research Style', 'Thought Leadership'], d: 'OpenAI\u2019s annual developer event.' },
  { m: 10, d: 4, n: 'GitHub Universe', t: 'tech', c: 'USA', r: 'Global', i: 'tech', e: '🐙', p: 78, tr: 85, df: 3, ct: ['Announcement', 'Educational'], d: 'GitHub\u2019s developer conference.' },
  { m: 4, d: 30, n: 'Microsoft Build', t: 'tech', c: 'USA', r: 'Global', i: 'tech', e: '🪟', p: 84, tr: 89, df: 2, ct: ['Announcement', 'Thought Leadership'], d: 'Microsoft developer conference.' },
  { m: 10, d: 20, n: 'NVIDIA GTC', t: 'tech', c: 'USA', r: 'Global', i: 'tech', e: '🎮', p: 83, tr: 94, df: 2, ct: ['Announcement', 'Research Style'], d: 'AI & accelerated computing conference.' },
  { m: 2, d: 1, n: 'Union Budget Day (India)', t: 'govt', c: 'India', r: 'National', i: 'finance', e: '📊', p: 88, tr: 90, df: 2, ct: ['Thought Leadership', 'Educational'], d: 'India\u2019s annual federal budget announcement.' },
  { m: 5, d: 12, n: 'International Nurses Day', t: 'health', c: 'Global', r: 'Global', i: 'health', e: '🩺', p: 70, tr: 72, df: 3, ct: ['Inspirational', 'Storytelling'], d: 'Honouring nurses worldwide.' },

  // ===================== AWARD SHOWS & ENTERTAINMENT =====================
  { m: 1, d: 7, n: 'Golden Globe Awards', t: 'entertainment', c: 'USA', r: 'Global', i: 'entertainment', e: '🏆', p: 78, tr: 80, df: 3, ct: ['Entertainment', 'Marketing'], d: 'Hollywood\u2019s film & TV awards.' },
  { m: 3, d: 2, n: 'Academy Awards (Oscars)', t: 'entertainment', c: 'USA', r: 'Global', i: 'entertainment', e: '🎬', p: 88, tr: 90, df: 2, ct: ['Entertainment', 'Marketing'], d: 'The most prestigious film awards.' },
  { m: 2, d: 2, n: 'Grammy Awards', t: 'entertainment', c: 'USA', r: 'Global', i: 'entertainment', e: '🎤', p: 82, tr: 84, df: 3, ct: ['Entertainment', 'Marketing'], d: 'Music industry\u2019s biggest night.' },
  { m: 10, d: 20, n: 'Filmfare Awards (India)', t: 'entertainment', c: 'India', r: 'National', i: 'entertainment', e: '⭐', p: 76, tr: 78, df: 3, ct: ['Entertainment', 'Marketing'], d: 'Bollywood\u2019s premier awards.' },
  { m: 10, d: 5, n: 'Nobel Prize Announcements', t: 'industry', c: 'Sweden', r: 'Global', i: 'education', e: '🏅', p: 80, tr: 82, df: 3, ct: ['Thought Leadership', 'Research Style'], d: 'Annual Nobel laureates revealed.' },
  { m: 3, d: 15, n: 'Indian Premier League (IPL) Season', t: 'sports', c: 'India', r: 'National', i: 'sports', e: '🏏', p: 90, tr: 94, df: 2, ct: ['Entertainment', 'Community', 'Marketing'], d: 'The world\u2019s biggest cricket league.' },
  { m: 8, d: 26, n: 'US Open Tennis', t: 'sports', c: 'USA', r: 'New York', i: 'sports', e: '🎾', p: 76, tr: 78, df: 3, ct: ['Storytelling', 'Community'], d: 'Grand Slam tennis championship.' },
  { m: 12, d: 10, n: 'Nobel Prize Ceremony', t: 'industry', c: 'Sweden', r: 'Stockholm', i: 'education', e: '🎖️', p: 74, tr: 76, df: 3, ct: ['Thought Leadership'], d: 'Nobel laureates receive their awards.' },

  // ===================== HISTORICAL & NICHE OBSERVANCES =====================
  { m: 9, d: 11, n: '9/11 Remembrance Day', t: 'observance', c: 'USA', r: 'Global', i: 'social', e: '🕯️', p: 72, tr: 70, df: 4, ct: ['Thought Leadership', 'Storytelling'], d: 'Remembering the 2001 attacks.' },
  { m: 12, d: 7, n: 'Pearl Harbor Remembrance', t: 'observance', c: 'USA', r: 'National', i: 'social', e: '⚓', p: 62, tr: 60, df: 5, ct: ['Storytelling'], d: '1941 attack remembrance day.' },
  { m: 6, d: 6, n: 'D-Day Anniversary', t: 'observance', c: 'Global', r: 'Global', i: 'social', e: '🪖', p: 66, tr: 64, df: 4, ct: ['Storytelling', 'Thought Leadership'], d: '1944 Normandy landings anniversary.' },
  { m: 7, d: 20, n: 'Moon Landing Day', t: 'observance', c: 'Global', r: 'Global', i: 'tech', e: '🌕', p: 74, tr: 76, df: 3, ct: ['Inspirational', 'Storytelling'], d: '1969 Apollo 11 anniversary.' },
  { m: 8, d: 6, n: 'World Wide Web Day', t: 'tech', c: 'Global', r: 'Global', i: 'tech', e: '🕸️', p: 66, tr: 72, df: 3, ct: ['Educational', 'Thought Leadership'], d: 'Celebrating the invention of the web.' },
  { m: 10, d: 14, n: 'World Standards Day', t: 'industry', c: 'Global', r: 'Global', i: 'tech', e: '📏', p: 50, tr: 52, df: 5, ct: ['Educational'], d: 'Celebrating global standards.' },
  { m: 10, d: 15, n: 'Global Handwashing Day', t: 'observance', c: 'Global', r: 'Global', i: 'health', e: '🧼', p: 58, tr: 60, df: 5, ct: ['Educational'], d: 'WHO hygiene awareness day.' },
  { m: 5, d: 8, n: 'World Red Cross Day', t: 'observance', c: 'Global', r: 'Global', i: 'health', e: '🩹', p: 60, tr: 62, df: 4, ct: ['Educational', 'Storytelling'], d: 'Honouring humanitarian work.' },
  { m: 9, d: 28, n: 'World Rabies Day', t: 'health', c: 'Global', r: 'Global', i: 'health', e: '🐕', p: 55, tr: 57, df: 5, ct: ['Educational'], d: 'Rabies prevention awareness.' },
  { m: 11, d: 19, n: 'World Toilet Day', t: 'observance', c: 'Global', r: 'Global', i: 'health', e: '🚻', p: 56, tr: 58, df: 5, ct: ['Educational'], d: 'UN sanitation awareness day.' },
  { m: 4, d: 23, n: 'World Book Day', t: 'education', c: 'Global', r: 'Global', i: 'education', e: '📚', p: 76, tr: 78, df: 3, ct: ['Educational', 'Community'], d: 'Celebrating reading and books.' },
  { m: 3, d: 21, n: 'World Poetry Day', t: 'entertainment', c: 'Global', r: 'Global', i: 'entertainment', e: '📝', p: 60, tr: 62, df: 4, ct: ['Community', 'Storytelling'], d: 'UNESCO poetry day.' },
  { m: 5, d: 21, n: 'International Tea Day', t: 'lifestyle', c: 'Global', r: 'Global', i: 'food', e: '🍵', p: 64, tr: 66, df: 4, ct: ['Community', 'Marketing'], d: 'Celebrating tea culture.' },
  { m: 10, d: 28, n: 'International Animation Day', t: 'entertainment', c: 'Global', r: 'Global', i: 'entertainment', e: '🎨', p: 58, tr: 60, df: 5, ct: ['Entertainment'], d: 'Celebrating animation art.' },
  { m: 6, d: 14, n: 'World Blood Donor Day', t: 'health', c: 'Global', r: 'Global', i: 'health', e: '🩸', p: 68, tr: 70, df: 3, ct: ['Educational', 'Inspirational'], d: 'WHO blood donation day.' },
  { m: 12, d: 5, n: 'World Soil Day', t: 'observance', c: 'Global', r: 'Global', i: 'environment', e: '🪱', p: 52, tr: 54, df: 5, ct: ['Educational'], d: 'UN soil conservation day.' },
  { m: 1, d: 24, n: 'International Day of Education', t: 'education', c: 'Global', r: 'Global', i: 'education', e: '🎓', p: 68, tr: 70, df: 3, ct: ['Educational', 'Thought Leadership'], d: 'UN education day.' },
  { m: 4, d: 30, n: 'International Jazz Day', t: 'entertainment', c: 'Global', r: 'Global', i: 'entertainment', e: '🎷', p: 58, tr: 60, df: 4, ct: ['Entertainment'], d: 'UNESCO jazz day.' },
  { m: 8, d: 9, n: 'Indigenous Peoples Day (UN)', t: 'observance', c: 'Global', r: 'Global', i: 'social', e: '🪶', p: 56, tr: 58, df: 5, ct: ['Thought Leadership'], d: 'UN indigenous peoples day.' },
  { m: 5, d: 10, n: 'World Migratory Bird Day', t: 'observance', c: 'Global', r: 'Global', i: 'environment', e: '🦅', p: 52, tr: 54, df: 5, ct: ['Educational'], d: 'Bird conservation awareness.' },
]
