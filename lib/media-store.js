...
import { driveList, driveUpload, driveDownload, driveDelete, driveMetadata, driveMove } from './gsheets'
...
export const mediaStore = {
  ...
  // True move between folders (no copy) — used for archive after publish
  async move(fileId, toFolderId) {
    return await driveMove(fileId, toFolderId)
  },
}
